...
function esegui_funzione(funzione){
	funzione=atob(funzione);
	eval(funzione);
}
	...
	timeoutback = setTimeout(function() {
		...
		switch (page) {
			...
			case 'promemoriaserv':
				...
				break;
			case 'arrivi':
				var timearrivi = $('#timearrivi').val();
				navigationtxt(17, timearrivi, 'arrividiv', 0);
				break;
		}
	}, 1000);
});
...
//var baseurl='http://5.249.144.194/scidoo/';
var baseurl='https://www.scidoo.com/';

//var baseurl='https://test.scidoo.com/scidoo/';
...
myApp.onPageInit('calendario', function(page) {
	...
	//var p=0;
	$('#tabdate').css('transform', 'translate3d(110px, 0px, 0px)');
...
function navigation(id, str, agg, rel) {
	...
	id = parseInt(id);
	var apriurl = [];
	apriurl[0] = 'config/profilo.php';
	apriurl[1] = 'config/profilocli.php';
	apriurl[2] = 'config/calendario.inc.php';
	apriurl[3] = 'config/detpren.php';
	apriurl[4] = 'config/centrobenessere.php';
	apriurl[5] = 'config/ristorante.php';
	apriurl[6] = 'config/pulizie_cont.php';//pulizie.php
	apriurl[7] = 'config/arrivi.php';
	apriurl[8] = 'config/prenotazioni.php';
	apriurl[9] = 'config/clienti.php';
	apriurl[10] = 'config/domotica.php';
	apriurl[11] = 'config/notifiche.php';
	apriurl[12] = 'config/appunti.php';
	apriurl[13] = 'config/ristorantegiorno.php';
	apriurl[14] = 'config/centrobenesseregiorno.php';
	apriurl[15] = 'config/dettavolo.php';
	apriurl[16] = 'config/profilo/servizi.php';
	apriurl[17] = 'config/profilo/temperatura.php';
	apriurl[18] = 'config/profilo/menuristorante.php';
	apriurl[19] = 'config/profilo/elencoservizi.php';
	apriurl[20] = 'config/profilo/ilconto.php';
	apriurl[21] = 'config/profilo/elencoluoghi.php';
	apriurl[22] = 'config/explodeservice.php';
	apriurl[23] = 'config/puliziedet.php';
	apriurl[24] = 'config/clientidet.php';
	apriurl[25] = 'config/profilo/detserv.php';
	apriurl[26] = 'config/profilo/detservizio.php';
	apriurl[27] = 'config/profilo/addserv.php';
	apriurl[28] = 'config/profilo/suggerimenti.php';
	apriurl[29] = 'config/profilo/galleria.php';
	apriurl[30] = 'config/profilo/recensioni.php';
	apriurl[31] = 'config/profilo/detrecensione.php';
	apriurl[32] = 'config/profilo/nuovarecensione.php';
	apriurl[33] = 'config/detluogo.php';
	apriurl[34] = 'config/nuovotavolo.php';
	apriurl[35] = 'config/menugiorno.php';
	apriurl[36] = 'config/impostazionialloggi.php';
	apriurl[37] = 'indexmobile.html';
	apriurl[38] = 'config/listinoprezzi.php';
	apriurl[39] = 'config/modprezzotariffe.php';
	//last 39
	var url = url + apriurl[id];
	//alert(url);
	/*
		...
		success: function(data) {
			...
			switch (agg) {
				case 1:
					...
					var altezzaparent = $('.views').height();
					var tabdate = 102;
					...
					setTimeout(function() {
						...
						var scrollvert = (heightcont - altezzaparent) * -1;
						//alert(scrollorz +'/-/'+scrollvert);
						$('#tabbody').pep({
				...
				case 7:
					...
					modalfirstentryospiti();
					 notifiche_reload=setInterval('reload_notifiche_mess()',60000); //notifiche chat
...
function navigationtxt(id, str, campo, agg, loader) {
	...
	var apriurl = [];
	apriurl[0] = 'profilo/temp.php';
	apriurl[1] = 'calendario.inc.php';
	apriurl[2] = 'detpren2.php';
	apriurl[3] = 'calendario2.inc.php';
	apriurl[4] = 'preventivo/step0.php';
	apriurl[5] = 'preventivo/step1.php';
	apriurl[6] = 'preventivo/step2.php';
	apriurl[7] = 'preventivo/step3.php';
	apriurl[8] = 'preventivo/step4.php';
	apriurl[9] = 'preventivo/step5.php';
	apriurl[10] = 'notifiche.inc.php';
	apriurl[11] = 'promemoria.php';
	apriurl[12] = 'appunti.inc.php';
	apriurl[13] = 'centrobenessere.inc.php';
	apriurl[14] = 'ristorante.inc.php';
	apriurl[15] = 'pulizie.inc.php';
	apriurl[16] = 'domotica.inc.php';
	apriurl[17] = 'arrivi.inc.php';
	apriurl[18] = 'clienti.inc.php';
	apriurl[19] = 'prenotazioni.inc.php';
	apriurl[20] = 'ristorantegiorno.inc.php';
	apriurl[21] = 'centrobenesseregiorno.inc.php';
	apriurl[22] = 'preventivo/step4cerca.php';
	apriurl[23] = 'profilo/servizi.php';
	apriurl[24] = 'profilo/prenotazione.php';
	apriurl[25] = 'profilo/temperatura.php';
	apriurl[26] = 'profilo/menuristorante.php';
	apriurl[27] = '/profilo/ilconto.php';
	apriurl[28] = 'profilo/elencoservizi.php';
	apriurl[29] = 'profilo/elencoluoghi.php';
	apriurl[30] = 'ricercaclidet.php';
	apriurl[31] = 'ricercaserv.php';
	apriurl[32] = 'centrobenesseregiorno.inc.php';
	apriurl[33] = 'aggiungipiatti2.php';
	apriurl[34] = 'tavoloordinazione.php';
	apriurl[35] = 'nuovotavolo.php';
	apriurl[36] = 'ricercapersscript.php';
	apriurl[37] = 'menugiorno.inc.php';
	apriurl[38] = 'cambiadatapren.inc.php';
	apriurl[39] = 'impostazionialloggi.inc.php';
	apriurl[40] = 'listinoprezzi.inc.php';
	apriurl[41] = 'nuovotavolo.inc.php';
	//41
	var url = url + apriurl[id];
	//alert(id);
	//alert(url);
	//alert('TXT'+id);
	//console.log(url,campo);
	query = new Array();
	query['IDcode'] = IDcode;
	var str = new String(str);
	//alert(str);
		...
		success: function(data) {
			...
			if ((num == -1) && (!isNaN(data))) {
				...
				if (time == 0) {
					...
					navigation(data, device_width, agg, 1);
					notifpush(1);
				} else {
					vislogin();
				}
		...
		success: function(data) {
			...
			switch (agg) {
				...
				case 2:
					...
					if(val==3){
						myApp.addNotification({
							message: 'Prenotazione in attesa di conferma',
							custom:'<div class="item-title">Prenotazione in attesa di conferma</div>',
							hold: 2000
						});
					}else{
						myApp.addNotification({
							message: 'Prenotazione confermata con successo!',
							custom:'<div class="item-title">Prenotazione confermata con successo!</div>',
							hold: 2000
						});
					}
	...
	$$.ajax({
		...
		success: function(data) {
			...
			switch (agg) {
				...
				case 14://pulizie
					//navigation(6,0,0,2);
					var schermata_pul=$('#schermata_pul').val();

					if(schermata_pul==0){
						//$('.button.tab-link.active').attr('onclick');
						navigationtxt2(23,'','pulizie_div_cont',7);	
					}else{
						navigationtxt2(24,'','pulizie_div_cont',7);
					}

					//var tempog=$$('#time').val()+',0';
					//navigationtxt(15,tempog,'puliziediv',0,1);
					//navigationtxt(15,0,'puliziediv',0,1);
				break;
				case 15://chat struttura
					navigationtxt2(22,id,'messaggi',5,1);
				break;
			}
		},
		error: function() {
...
function selectservice(ID, tipolim, IDtipo, durata, agg, time) {
	...
	$$.ajax({
		...
		success: function(data) {
			myApp.hideIndicator();
			$$('#add2').html(data)[0].dataset.tipolim = tipolim;
			$$('#buttadddiv').css('display', 'block');
			if (tipolim11 == 6) {
				var totale = 0;
...
function addservice2(agg, tipoadd) {
	...
	reloadnav = 1;
	var data = {};
	data.tipolim = tipolim;
	data.tipo = tipoadd;
	switch (tipolim) {
		case 1:
			var vals = serviziriep.split('_');
			data.IDserv = vals[2];
			data.list = [{
				infop: vals[0],
				time:vals[1]
		...
		case 7:
		case 8:
			var entries = serviziriep.split('/////');
			var vals = entries[0].split('_');
			data.IDserv = vals[2];
			var infop = []
			for (var v of entries) {
				if (!!v) {
					v = v.split('_');
					infop.push(v[0]);
				}
		...
		case 6:
			serviziriep = '';
			mioArray = document.getElementsByClassName('cent')
			if (mioArray.length > 0) {
				data.IDserv = mioArray[0].getAttribute('alt');
				data.list = [{
					time: mioArray[0].getAttribute('dir'),
					qta: mioArray[0].innerHTML
				}];
	...
	console.log(serviziriep);
	console.log(data);
	if ((serviziriep.length > 0) && (nump == 1)) {
		var dataString = 'arrins=' + serviziriep + "&orario=" + orario11 + "&note=" + note + "&IDtipo=" + IDtipo + "&personale=" + personale11 + "&prezzo=" + prezzo + "&durata=" + durata + "&tipolim=" + tipolim + "&tipoadd=" + tipoadd
				...
				onClick: function() {
					myApp.prompt('Inserisci prezzo:', function(value) {
						if (!isNaN(value)) {
							...
							//alert(IDdati);
							//modprenot(IDdati,value,98,10,7)
							modprenextra(value, IDdati, 44, 9, 4);
						} else {
...
function azionevideo(id, stato) {
	...
	/*
	buttons.push({
			text: '<div>Crea ticket</div>',
			onClick: function (){}
	});
	
	buttons.push({
			text: '<div>Visualizza ticket</div>',
			onClick: function (){}
	});*/
 
	var valorebtn = $$('#valorebtn' + id).val();  
	...
	myCalendar2 = myApp.calendar({
		...
		onChange: function(p, values, displayValues) {
			...
			*/
			...
			if(id==6){
				var schermata=$('#schermata_pul').val();
				var idtxt=23;
				if(schermata==1){
					idtxt=24;
				} 
				if(tempo!=tempotime){
					navigationtxt2(idtxt,tempo,'pulizie_div_cont',agg);
					myCalendar2.close();
					$('#tempotime').val(tempo); 
					var datan= new Date(values);
					var mese=datan.getMonth();
					var g=datan.getDate();
					$('#datacalen').html(g+' '+monthNamesShort[mese]);
				}
...
function argomentonuov() {
	...
	if (value == 0) {
		myApp.confirm('<input type="text" autocomplete="off" placeholder="argomento nuovo" id="nuovoinp"> ', function() {
	...
	//var testo='<input type="text" autocomplete="off" placeholder="nuova categoria" id="catnuov" >';
	//myApp.popup(testo);
}
