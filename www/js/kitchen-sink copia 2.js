		...
		$$.ajax({
                ...
                success: function (data) {
					...
					if(num==-1){		
						...
						//$$('#logged').html('<a href="javascript:void(0)" onclick="navigation('+"0,'',0"+')" class="button button-big button-fill" style=" width:40%; margin:auto; background:#ff9c00;">Entra su Scidoo</a>');
                ...
                success: function (data){
					...
					if((num==-1)&&(!isNaN(data))){
						...
						if(time==0){
							...
							//mainView.history = []; 
							azzerastoria();
	//						$$('#logged').html('<a href="javascript:void(0)" onclick="navigation('+data+",'',"+agg+')" class="button button-big button-fill" style=" width:40%; margin:auto; background:#ff9c00;;">Vai alla Home</a>');
