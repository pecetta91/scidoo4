				...
				<div class="navbar-inner">
					<div class="left navbarleftsize170">
					 ...
					 <a href="#" class="link icon-only back" >
						...
						<strong class="stiletitolopagine">Domotica</strong>
					</a>
				...
				<div class="subnavbar subnavbarbordersotto" align="center">
					<div class="ristorante-navbar"  >
						<table style="width:90%;">
						 <tr>
						  <td style="width:46%">
		                    <a class="buttonristo first active" id="tavoli" onclick="buttonristoact(1);navigationtxt(16,'."'1'".','."'domoticadiv'".',0)">Strumenti</a>
						  </td>
						  <td style="width:46%">
							<a class="buttonristo last" id="sale" onclick="buttonristoact(2);navigationtxt(16,'."'2'".','."'domoticadiv'".',0);">Alloggi</a>
						 </td> 
						</tr>
					</table>
				</div>
