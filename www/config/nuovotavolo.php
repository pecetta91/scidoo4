               ...
               <div class="navbar-inner">
                  <div class="left navbarleftsize170">
					 <a href="#" class="link icon-only" onclick="creasessione(0,88);mainView.router.back();"  >
						<i class="material-icons fs30 mt5">apps</i>
						<strong class="stiletitolopagine mt-5" >Aggiungi Tavolo</strong>
						<span  class="testosottotitololeft"><?php echo $nomesottotip ?></span>
					</a>
