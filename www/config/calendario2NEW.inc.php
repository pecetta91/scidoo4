...
<div class="table-fixed-right"  id="tabcalmain"   style="z-index:99;" >
	  <table id="tabbody" style="margin-top:3px; z-index:100 ;    margin-left: 25px;" class="fixed_headers">
	  	<thead>'.$txtbody2.'</thead>
		<tbody>'.$txtbody.'</tbody>
	  </table>
</div>
