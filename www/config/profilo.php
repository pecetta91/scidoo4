...
$query2="SELECT ID FROM notifiche WHERE IDdest='$IDpers' AND time>='$time' AND IDstr='$IDstruttura' AND letto='0'";
$result2=mysqli_query($link2,$query2);
...
$testo=  '<div data-page="profilo" class="page"> 			
			<div class="navbar" >
				<div class="navbar-inner">
					<div class="left" ><img src="logoscidoo.png" style="width:37px; padding:4px; border-radius:50%;"></div>
					<div class="center" >Benvenuto</div>
					<div class="right">
					
					<a href="#" onClick="navigation(11,0,0)"style="height:45px; margin-left:10px;">
						<i class="icon " style="line-height:10px; margin-top:5px;" >
						<i class="icon f7-icons" style="font-size:19px; ">bell_fill</i><br>
						<div style="font-size:8px;font-weight:600;">NOTIFICHE</div>
						<span class="badge bg-red" id="numnotifiche2" style="margin-left:-10px; margin-top:-3px;">'.$numnot.'</span>
					</i>
					</a>
					<a href="#" onClick="navigation(12,0,0)"   style="height:45px;">
						<i class="icon " style="line-height:10px; margin-top:5px;" >
						<i class="icon f7-icons" style="font-size:19px; ">list</i><br>
						<div style="font-size:8px;font-weight:600;">APPUNTI</div>
						<div class="badge bg-green" id="numappunti2" style="margin-left:-12px; margin-top:-3px;">'.$numapp.'</div>
					</i>
					</a>
					</div>				
	...
	$txtcolor=array('3976d1','c139d1','e77f19','2cb443','d2c823','3539ca','35a2ca','7b8f97');
		...
		if($pos==1){
			...
			$testo1.= '
			  ...
			  <a href="#" class="item-link item-content">
				...
				if($txticon[$dato]==''){
					$testo1.='
					<div style="text-align:center;margin-top:5px;"><i class="material-icons" style="color:#'.$txtcolor[$dato].'; font-size:28px;">'.$txticonimage[$dato].'</i></div>';
				}else{
					
					$testo1.='<div style="text-align:center;"><i class="icon f7-icons" style="color:#'.$txtcolor[$dato].'; font-size:22px;">'.$txticon[$dato].'</i></div>';
				}
				$testo1.='
				</div>
