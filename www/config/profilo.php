...
$query2="SELECT ID FROM notifichetxt WHERE IDdest='$IDpers' AND time>='$time' AND IDstr='$IDstruttura' AND letto='0'";
$result2=mysqli_query($link2,$query2);
...
$testo=  '<div data-page="profilo" class="page"> 			
			<div class="navbar" >
				<div class="navbar-inner">
					<div class="center"><img src="ScidooLOGOmin.png" style="width:110px;"></div>
				</div>
				</div>
