...
<form class="searchbar searchbar-init" style="background:none;">
    <div class="searchbar-input" style="width:90%" >
      <input type="search" class="inputricerca ricercainputpicker" placeholder="Ricerca Ospite" onkeyup="navigationtxt(36,this.value,'."'contencli'".')"><a href="#" class="searchbar-clear"></a>
