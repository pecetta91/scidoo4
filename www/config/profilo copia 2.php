...
$testo=  '<div data-page="profilo" class="page"> 			
			<div class="navbar" >
				<div class="navbar-inner">
					<div class="center"><img src="scidoob.png" style="width:130px; margin-top:5px;"></div>
			...
			<div class="toolbar tabbar tabbar-labels" style="background:#2c68ba; display:none;box-shadow: 0px -1px 3px 0px rgba(0,0,0,0.2);
">
			<div class="toolbar-inner">
				<a href="#" class="tab-link" onClick="navigation(12,0,0)">
					<i class="icon f7-icons" >book
	...
	$testo1='<div style="width:100%; margin:0px; padding:0px; padding-top:56px">';
	
	$testo1.='
		<table style="width:100%; height:70px; background:#fff; border-top:solid 1px #ccc; border-bottom:solid 1px #ccc;" cellspacing="10"><tr>
<td style="text-align:center;font-weight:300;font-size:15px; border-right:solid 1px #ccc;" width="31%">

<span style="color:#666;">Arrivi di oggi</span><br>
<b style="font-size:20px;color:#203baf; ">N. 5</b>

</td>
<td style="text-align:center;font-weight:300;font-size:15px; " width="31%">

<span style="color:#666;">Incasso giornalieri</span><br>
<b style="font-size:20px;color:#203baf;">150 €</b>
	...
	$testo1.='<div style="width:100%; overflow:hidden;">
		<div style="width:100%; padding:0px;padding-left:1%;" align="center">
      <br>
	';
  ...
  width:103px; padding:0px; height:103px; border-radius:5px; padding:10px; text-align:left;" >
				...
				//<div style="font-size:10px; color:#999; font-weight:600; margin-top:10px;">N.3 Sospesi</div>
				if($txticon[$dato]==''){
					$testo1.='<div style="font-weight:600; width:100%; text-align:center; color:#555; font-size:13px; text-transform:uppercase;">'.$txtfunc[$dato].'</div>
					<div style=" text-align:center; margin:auto; margin-top:10px; width:65px;  height:65px; border-radius:50%; background-color:#'.$txtcolor[$dato].';">
					<i class="material-icons" style="color:#fff; line-height:65px; font-size:35px;">'.$txticonimage[$dato].'</i>
					</div>
				...
				$testo1.='
				  ...
				  <div style="width:100%; margin-top:8px; font-size:11px; text-transform:uppercase;color:#333; font-weight:600;" align="center">
				  </div>
				  </div>
				  ';
