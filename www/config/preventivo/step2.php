...
if($gg==0){
	...
	$query="SELECT a.nome,a.categoria,a.ID,c.colore FROM appartamenti as a,categorie as c WHERE a.ID NOT IN($groupid)  AND a.attivo='1' AND a.IDstruttura='$IDstruttura' AND a.categoria=c.ID $qadd ORDER BY a.categoria";
	$result=mysqli_query($link2,$query);
	if(mysqli_num_rows($result)>0){
