...
//selpacc('.$IDapp.',0,this)
									...
									if($jj==1){
											...
											$prezzo=0;
												$prezzopacctot=0;
													...
													$testo.='
														<li>
														  <a href="#" class="item-link item-content" '.$clas.' onclick="selectpers('.$IDserv.',0,5,0)">
															<div class="item-inner">
  ...
  <ul>';
					...
					$func='onclick="selectpers('.$rowreg['0'].','.$rowreg['4'].',7,0)"';
				...
				if(mysqli_num_rows($result2)>0){
					while($row2=mysqli_fetch_row($result2)){
						...
						$testo.='
						  ...
						  <a href="#" class="item-link item-content" style="height:55px;"  onclick="selectpers('.$IDcof.','.$row2['3'].',8,0)">
							<div class="item-inner">
							  <div class="item-title-row">
