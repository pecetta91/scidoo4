...
<div data-page="addservice" class="page" > 
			...
			<a href="#" class="button button-fill  " onclick="msgboxelimina('.$id.',1,0,2)" style="width:80%; font-size:14px; font-weight:600;  height:45px; margin:auto; line-height:40px;">AGGIUNGI SERVIZIO</a>
