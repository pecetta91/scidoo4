  ...
  <div class="navbar">
               <div class="navbar-inner">
                  <div class="left" style="width:70px;">
				 	 <a href="#add1" class="tab-link tabindietro" style="display:none;" onclick="backselect2()"><i class="icon f7-icons" style=" width:60px;  font-size:25px;">chevron_left</i></a>
				  </div> 
                  <div class="center"  style="font-size:14px; font-weight:600; ">AGGIUNGI UN SERVIZIO</div>
                  <div class="right" onclick="mainView.router.back(); navigationtxt(7,0,'."'step4'".',0);calcolatot();" style="width:60px; ">
	...
	<div class="page-content" > 		
			...
			<div class="tabs-animated-wrap" style="height:2000px;">
...
$testo.='
		...
		<div id="add2" class="tab " style="overflow-y:visible;" >
</div>
		...
		//onclick="'.$func.'"
	$testo.='<div id="buttonaddprev" onclick="aggiungis()">Aggiungi</div>
