...
';
									...
									$txtk[$IDsalap][$timeprenextra].='
										<li class="accordion-item" style="border-top:solid 1px #f1f1f1;">
											...
											<div class="item-inner">
											 ...
											 <div class="item-after" style="width:80px;">
											 
											 <table><tr><td style="border-right:solid 1px #ccc; color:#1649b1;">
      ...
      <div class="accordion-item-content"  style="padding:0px;">
        <div class="content-block" id="into'.$IDprenextra.'"style="padding:0px;">';
		
		 include('ristointo.php');
				...
				if(!isset($txtk[$IDsalamain][$timeprenextra])){$txtk[$IDsalamain][$timeprenextra]='';}								
					...
					foreach($sale as $IDsala =>$nomesala){
						...
						if(isset($txtk[$IDsala])){
							$badge='<div class="badge bg-red bagristo">'.count($txtk[$IDsala]).'</div>';
						}
							
						$testo.='<a href="#IDsalaristo'.$IDsala.'"  class="tab-link button   '.$active.' " style="overflow:visible;">'.$nomesala.'
						'.$badge.'
						</a>';
						...
						if(isset($txtk[$IDsala])){
							$txtinto.='<div class="list-block accordion-list">
      							<ul>';
		     	 ...
		     	 <div class="content-block" id="ristorantegiornodiv" style="padding:0px; width:100%;">
						...
						<div class="tabs-animated-wrap" style="">
