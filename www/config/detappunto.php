...
<div class="pages navbar-fixed">
  ...
  <div class="navbar">
               <div class="navbar-inner">
			   		<div class="left navbarleftsize170"> <a href="#" class="link" onclick="backexplode(3)">
						<i class="material-icons fs30" >chevron_left</i>
						<strong class="stiletitolopagine">Appunto</strong>
						</a>
...
if($IDappunto==0){
	...
	$testo.='
	 ...
	 <div class="content-block-title titleb">Appunto</div>
			 ...
			 <div class="item-content" style="height:100%;">
			  <div class="item-inner" style="width:100%;height:100%;">
				  <div class="item-input">
            		<textarea id="noteappunto" class="textareapren" style="height:150px" placeholder="Appunto"></textarea>
        	  </div>
			 </div>
			 </div>
			</li>
			</ul></div>
		<div class="list-block mt25"><ul>
			<li>
		  ...
		  <a href="#" class="item-link smart-select" data-open-in="picker" pickerHeight="400px">
			...
			<div class="item-content">
			  <div class="item-inner">
				<div class="item-title">Argomento<br/>
			<b style="font-size:10px; color:#b20036;">(*) Obbligatorio</b></div>
      ...
      <a href="#" class="item-link smart-select " data-open-in="picker" pickerHeight="400px" >
        ...
        <div class="item-content">
          <div class="item-inner">
            <div class="item-title">Destinatari<br/>
			<b style="font-size:10px; color:#b20036;">(*) Obbligatorio</b></div>
            <div class="item-after" style="font-size:13px">Inserisci Destinatari</div>
          </div>
        </div>
      </a>
    </li>
