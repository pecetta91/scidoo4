...
<div data-page="centrobenesseregiorno" class="page"> 
			 <div class="navbar" >
				<div class="navbar-inner">
					...
					<div class="right"  >
						<a href="#" onclick="opensosp()" style="width:35px; height:50px; text-align:center; margin-top:17px; margin-left:6px;">
							<i class="icon" style="line-height:10px;">
								<i class="material-icons" style="font-size:25px; margin-left:3px; ">watch_later</i>
								<br>
								<div style="font-size:9px;font-weight:600; margin-top:3px;">Sospesi</div>
								
								<span class="badge bg-red" id="badgecentro" style="margin-left:-15px; "></span>
							</i>
						</a>
						<a href="#" onclick="selprenot()" style="width:35px; height:50px; margin-top:15px; text-align:center;">
							<i class="icon" style="line-height:10px;">
								<i class="material-icons" style="font-size:30px;  margin-top:0px; ">add</i><br>
								<div style="font-size:9px;font-weight:600; margin-left:-2px;">Aggiungi</div>
