...
<div class="pages navbar-fixed">
  <div data-page="detpren" class="page with-subnavbar">
      ...
      <div class="navbar-inner">
		...
		<div class="left navbarleftsize170" ><a href="#" class="link back" onclick="openp=0;">
							<i class="material-icons">chevron_left</i>
							<strong class="stiletitolopagine">'.$nome.'</strong>
						</a>
						
						</div>
					<div class="center titolonav"></div>
					<div class="right">
						<a href="#"  onclick="funzionidetpren('.$id.')" ><i class="icon f7-icons fs25">gear</i></a>
						<a href="#"  onclick="addserv('.$id.')" class="mr25"><i class="icon f7-icons fs25">add</i></a>
					</div>
		
        <div class="subnavbar subnavbarbordersotto">
