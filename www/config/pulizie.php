					...
					<div class="left navbarleftsize170">
					 ...
					 <a href="#" class="link icon-only back" >
						<i class="material-icons">chevron_left</i>
							<strong class="stiletitolopagine">Pulizie</strong>
					</a>
				
					</div>
					<div class="center titolonav"></div>
					<div class="right"></div>
					<div class="subnavbar subnavbarbordersotto" align="center">
					<div class="ristorante-navbar" style="margin-left: calc(10% - 8%);" >
						<table style="width:100%">
						 <tr>
						  <td style="width:30%">
		                    <a class="buttonristo first active" id="all" onclick="pulizienav(1);navigationtxt(15,'."'0,2'".','."'".'puliziediv'."'".',0);">Alloggi</a>
						  </td>
						  <td style="width:30%">
							<a class="buttonristo middle" id="prog" onclick="pulizienav(2);navigationtxt(15,'."'0,3'".','."'".'puliziediv'."'".',14);">Arrivi</a>
						 </td> 
						 <td style="width:30%">
							<a class="buttonristo last" onclick="pulizienav(3);navigationtxt(15,'."'0,4'".','."'".'puliziediv'."'".',14);" id="pul">Pulizie Extra</a>
						 </td>
						</tr>
					</table>
				</div>
