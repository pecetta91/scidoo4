...
<div data-page="registrazione" class="page" > 
		 	<div class="navbar" id="navcal" >
				<div class="navbar-inner">
					...
					<div class="center"><img src="logoscidoow.png" class="mt5 width90"></div>
					<div class="right"></div>
				</div>
			</div>
					...
					<div class="list-block">
							...
							<a href="#" class="item-link smart-select" data-open-in="picker">
								...
								<div class="item-content">
								  <div class="item-inner">
									...
									<div class="item-after" id="tipo" >Tipo di attività</div>
								  </div>
								</div>
							  </a>
						</li>
						...
						<li>
						 ...
						 <li>
						  <div class="item-content">
							<div class="item-inner">
							  <div class="item-title label">Prezzo Medio €</div>
							  <div class="item-input" >
...
/*
		  ...
		  */
		  ...
		  $testo.='<br>
            ...
            <a href="javascript:void(0)" onclick="datiregistrati()" class="button button-big button-fill sendform accedi" >Registrati</a><br/><hr class="mt20">
           
			<p class="fs13 c666 mt15 center" >
