			 ...
			 <div class="navbar">
				<div class="navbar-inner">
					<div class="left navbarleftsize260">
					 ...
					 <a href="#" class="link icon-only lh15" onclick="backexplode2(2);"  >
						<i class="material-icons">chevron_left</i>
							<strong class="stiletitolopagine">MENU: '.$sottotipname.'<br><span style="font-size:11px;">'.dataita($time).'</span></strong>
					</a>
