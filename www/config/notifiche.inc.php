				...
				if(mysqli_num_rows($result2)>0){
					...
					while($row2=mysqli_fetch_row($result2)){
						...
						<div class="row" style="background:#fff;  '.$letto.' color:#000; border-top:solid 1px #f1f1f1; border-bottom:solid 1px #f1f1f1;">
							<div class="col-20" style="font-weight:100;color:#203a93; font-size:13px;padding-top:10px; padding-left:10px;">		
								<strong>'.date('H:i',$row2['2']).'</strong>
								<br/><span style="font-size:9px;color:#666; ">'.calcolatime($timenow,$row2['2']).'</span>
							</div>
