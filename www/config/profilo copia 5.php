...
//<img src="scidoopng.png" class="width100" style="width:90px; margin-top:5px;">
		$testo.='	<div class="navbar" style="background:#fff;">
				<div class="navbar-inner">
					<div class="left"><div class="cfff ml10 fs24 fw600" >
					
					
					</div></div>
					<div class="center"><strong style="text-transform:capitalize; font-size:22px; color:#333;">Scidoo</strong></div>
					<div class="right"></div>
				</div>
			</div>
				';
...
<div class="sliderdiv" style="background:#f9f8f9; background:#00c7ae; ">';


$testo1.='
<div class="overmano btnone" style="background:#f9f8f9; background:#00c7ae;">
 ...
 $iconaawe=array('icon ion-ios-calendar-outline','icon ion-leaf','icon ion-android-restaurant','icon ion-ios-bolt-outline','icon ion-ios-home-outline','icon ion-android-list');
	...
	foreach($ffunc as $dato){
		...
		if($pos==1){
			...
			//style="background-color:#'.$schermo[$dato].';"
		$testo1.='
