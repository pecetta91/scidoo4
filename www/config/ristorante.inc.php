...
$testo='
	...
	<input type="hidden" id="contenutodiv" value="'.$vis.'">
	...
	$testo.='<br>';
		...
		if(mysqli_num_rows($resultmain)>0){
			while($row=mysqli_fetch_row($resultmain)){
				...
				<div class="col-60"><strong>'.$row['1'].'</strong></div>
				<div class="col-40"><a href="#" onclick="navigation(35,'.$IDsottotip.',0,0)"  class="button button-round color-gray "  style="width:100px; font-size:11px; margin-left:10px;">Nuovo/Modifica</a></div>
   ...
   ';
								if(isset($arrextra[$ggs][$IDsotto])){
									...
									<div class="row rowlist no-gubber tiporisto tiporistopresente"  onclick="
									  navigation(13,'."'".$timeextra.",".$IDsotto.",0'".',10,0)">
