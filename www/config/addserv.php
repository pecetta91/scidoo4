...
if($tipo==2){
	...
	$input='<input type="search" id="ricercaserv" placeholder="'.$txtc.'" style="height:30px;"  onkeyup="cercaservizio(this.value,'.$tipo.')"/>';
}
...
<div data-page="addservice" class="page" > 
            <div class="navbar">
					...
					<div class="col-20"> <a href="#add1" class="tab-link tabindietro" style="display:none;" onclick="backselect()"><i class="icon f7-icons" style=" width:60px;  font-size:25px;">chevron_left</i></a></div>
					<div class="col-60" style="font-weight:600; font-size:15px; text-transform:uppercase; text-align:center;">'.$input.'</div>
			 ...
			 <div class="item-content" style="height:100%;">
			  <div class="item-inner" style="width:100%;height:100%;">
				  <div class="item-input">
            		<textarea id="notaserv" style="height:90px" placeholder="Appunto"></textarea>
        	  </div>
			 </div>
			 </div>
			</li>
		  ...
		  <ul>
			<li>
			 <div class="item-content" style="height:100%;">
			  <div class="item-inner" style="width:100%;height:100%;">
				  <div class="item-input">
            		<input type="number" id="notaprezzo" placeholder="Prezzo" style="text-align:left; font-size:16px;" value="">
        	  </div>
			 </div>
			 </div>
			</li>
