...
<br>
<div style="padding:10px 25px">';//<div class="timeline verticale">
...
for($i=0;$i<=$gg;$i++){
	...
	//foreach($sottot as $IDsotto =>$sottotipologia){
		...
		if(strlen($txtmenu)>0){
			$testo.='<div>
					<div style="width:40px;line-height:14px;">'.date('d',$timeg).'<br><small>'.$giorniita3[date('w',$timeg)].'</small></div>
						<div class="content-block inset" style="padding:5px 40px;margin-top:5px;margin-bottom:15px;border-bottom:1px">
