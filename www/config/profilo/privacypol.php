					...
					<div class="left navbarleftsize170">
					  ...
					  <a href="#" class="link icon-only back">
						<i class="material-icons">chevron_left</i>
							<strong class="stiletitolopagine">'.$titolopriv.'</strong>
					</a>
					</div>
	...
	case 1:			
		...
		<p class="fs18 txtnero"><strong>Informativa sulla privacy</strong></p>
								...
								<div class="list-block accordion-list">
									  <ul>
										<li class=" bordoaccordion" id="accordion1" onclick="apriacc(1)">
										...
										<li class=" bordoaccordion" id="accordion2" onclick="apriacc(2)">
										<a href="#" class="item-content item-link">
											<div class="item-inner">
										...
										<li class=" bordoaccordion" id="accordion4" onclick="apriacc(4)">
										<a href="#" class="item-content item-link">
											<div class="item-inner">
										...
										<li class=" bordoaccordion" id="accordion5" onclick="apriacc(5)">
										<a href="#" class="item-content item-link">
											<div class="item-inner">
										...
										<li class=" bordoaccordion" id="accordion6" onclick="apriacc(6)">
										<a href="#" class="item-content item-link">
											<div class="item-inner">
										 ...
										 <li class=" bordoaccordion" id="accordion7" onclick="apriacc(7)">
										 <a href="#" class="item-content item-link">
											<div class="item-inner">
										 ...
										 <li class=" bordoaccordion" id="accordion8" onclick="apriacc(8)">
										 <a href="#" class="item-content item-link">
											<div class="item-inner">
...
$testo.='  					
								<div class="list-block">
  								<ul>
								 <li class="" id="accordion9" onclick="apriacc(9)">
								 <a href="#" class="item-content item-link">
									<div class="item-inner">
