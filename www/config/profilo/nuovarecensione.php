...
$testo='<div data-page="suggerimenti" class="page" > 
				...
				<div class="navbar-inner">
					...
					<a href="#" class="link icon-only back"    >
						<i class="material-icons">chevron_left</i>
							<strong class="stiletitolopagine">Nuova Recensione</strong>
					</a>
					</div>
		 ...
		 <div class="page-content ">
		  ...
		  <ul class="primadopo">
			 ...
			 <div class="item-content h100" >
			  <div class="item-inner h100" >
				  <div class="item-input">
            		<textarea id="titolo" style="height:40px" class="textareapren" placeholder="Titolo"></textarea>
        	  </div>
			 </div>
			 </div>
			</li>
			...
			<div class="list-block"><ul  class="primadopo">
				<li>
			 <div class="item-content h100" >
			  <div class="item-inner h100" >
				  <div class="item-input">
            		<textarea id="recensione"  style="height:120px" class="textareapren" placeholder="Recensione"></textarea>
        	  </div>
			 </div>
			 </div>
			</li>
