...
unset($_SESSION['IDpersadd']);
	...
	$txt='
	<div class="titleb">Seleziona date e persone</div><br>
	
	<div class="list-block accordion-list" id="tabselect" style="padding:1px;">
  		<ul>
	';
			...
			for($i=$time0;$i<=$checkout;$i+=86400){
				...
				if((isset($arr[$key2][$i]))||(isset($arr[-1][$i]))){
					...
					<li id="'.$kk.'">
					  <label class="label-checkbox item-content ">
						...
						<input type="checkbox"  '.$func.' name="soggetti"  alt="'.$prezzo.'" align="'.$i.'" lang="'.$key2.'_'.$i.'_'.$IDserv.'_'.$dato2.'" dir="'.$tipo.'">
				...
				';
					...
					*/
					...
					<li  id="'.$kk.'">
					  <label class="label-checkbox item-content">
						<input type="checkbox" name="soggetti"  onchange="selectbutt(this)" lang="'.$key2.'_'.$i.'_'.$IDserv.'_'.$dato2.'" alt="'.$prezzo.'"
						
						 align="'.$i.'" lang="'.$key2.'_'.$i.'_'.$IDserv.'_'.$dato2.'" 
						>
						<div class="item-media">
						  <i class="icon icon-form-checkbox"></i>
						</div>
				...
				';
					...
					/*
					$txt.='<div class="sopra t'.$i.' in'.$key2.' icon3g bb" dir="3" align="'.$i.'" id="'.$kk.'" lang="'.$key2.'_'.$i.'_'.$IDserv.'_'.$dato2.'" onclick="selectbutt(this)">'.$pres.'</div>';*/
				}
