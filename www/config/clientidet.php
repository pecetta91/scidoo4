...
if($tipoID==1){
	...
	$IDcliente=$row['0'];
	$txtright='<a href="#" onclick="ricercaclidetdiv('.$IDinfop.')" class="link icon-only" >
						
						<i class="material-icons">search_strong</i>
					</a>';
...
<div data-page="detcliente" class="page"> 
			 ...
			 <div class="navbar">
				<div class="navbar-inner">
					<div class="left navbarleftsize170" onClick="backexplode(6)" >
					 <a href="#" class="link icon-only" >
					 	<i class="material-icons">chevron_left</i>
						<strong class="stiletitolopagine">'.$nomecliente.'</strong>
					</a>
					
					
					</div>
					<div class="center "></div>
					<div class="right"> '.$txtright.'</div>
				</div>
			</div>
  ...
  <ul>
    <li>
      <div class="item-content">
        ...
        <div class="item-inner">
          <div class="item-title label spancampo">Nome</div>
	...
	<li>
      <div class="item-content">
        <div class="item-media mediaright"><i class="icon f7-icons">person</i></div>
        <div class="item-inner">
          <div class="item-title label spancampo">Cognome</div>
          <div class="item-input">
    ...
    <li>
      <div class="item-content">
        ...
        <div class="item-inner">
          <div class="item-title label spancampo">E-mail</div>
          <div class="item-input">
	...
	<li>
      <div class="item-content">
        ...
        <div class="item-inner">
          <div class="item-title label spancampo">Telefono</div>
          <div class="item-input">
	...
	<li>
      <div class="item-content">
        <div class="item-media mediaright"><i class="icon f7-icons">phone</i></div>
        <div class="item-inner">
          <div class="item-title label spancampo">Cellulare</div>
          <div class="item-input">
    ...
    <li>
      <div class="item-content">
        ...
        <div class="item-inner">
          <div class="item-title label spancampo">Sesso</div>
          <div class="item-input">
    ...
    <li>
      <div class="item-content">
        ...
        <div class="item-inner">
          <div class="item-title label spancampo">Data di Nascita</div>
          <div class="item-input">
			...
			<li>
			 <div class="item-content" style="height:100%;">
			  <div class="item-inner" style="width:100%;height:100%;">
				  <div class="item-input">
            		<textarea onchange="modprenot('.$IDcliente.',this,70,11,0);" style="height:90px" placeholder="Note" class="textareapren">'.$note.'</textarea>
        	  </div>
			 </div>
			 </div>
			</li>
		  ...
		  <ul class="primadopo">
			<li>
			 <div class="item-content" style="height:100%;">
			  <div class="item-inner" style="width:100%;height:100%;">
				  <div class="item-input">
            		<textarea style="height:90px"  onchange="modprenot('.$IDcliente.',this,137,11,0);" class="textareapren">'.$noteristo.'</textarea>
        	  </div>
			 </div>
			 </div>
			</li>
